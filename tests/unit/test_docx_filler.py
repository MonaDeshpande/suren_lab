...
class TestDocxSampleTable:
    ...
    def test_no_generator_stamp_in_ctr_docx(self):
        ...
        for section in doc.sections:
            ...
            footer_parts.extend(p.text for p in footer.paragraphs)
        footer = "\n".join(footer_parts)
        assert "Reception Test" in footer
        assert "Review" in footer
        assert "2026-07-31" in footer or "31/07/2026" in footer or "2026" in footer
